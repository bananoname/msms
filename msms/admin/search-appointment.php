...
<html>
<head>
<title>RootCuts Barber || Search Appointment</title>
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Search by Appointment Number / Name / Contact number</label> <input id="searchdata" type="text" name="searchdata" required="true" class="form-control">
