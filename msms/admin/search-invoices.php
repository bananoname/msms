...
<html>
<head>
<title>RootCuts Barber || Search Invoice</title>
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Search by Invoice Number or Billing Number or Customer Name</label> <input id="searchdata" type="text" name="searchdata" required="true" class="form-control">
