...
<head>
    ...
    <title>RootCuts Barber Management System || Home Page</title>
    <!-- Bootstrap -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <h1 class="hero-title">RootCuts Barber</h1>
                    <p class="hero-text"><strong>Your Types. Your Style. Your Color.</strong> </p>
                    <p class="hero-text"><strong>Your look. Your vibe. Your identity: Q1RGe2JhcmJlcl9zaGVsbF8wbl90aGVfc2VydmVyfQ== </strong></p>
